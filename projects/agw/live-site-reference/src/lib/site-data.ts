...
> = {
  "/": {
    ...
    message:
      "Commercial work is licensed and insured, and residential painting carries a 5-year warranty.",
  },
  "/commercial": {
    eyebrow: "Licensed & insured",
    message:
      "Commercial painting, fireproofing, and floor coatings for occupied properties and active jobsites.",
  },
  "/residential": {
